    ...
    public class InventoriesController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Inventories != null ? 
                          ...
                          Problem("Entity set 'InventoryDbContext.Inventories'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("InventoryId,Name,Details,QtyInStock,LastUpdated")] Inventory inventory)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("InventoryId,Name,Details,QtyInStock,LastUpdated")] Inventory inventory)
        {
